...
staffRoutes.get('/orphans/:childCode/visits', asyncHandler(staffController.getOrphanVisits));
staffRoutes.post('/orphans/:childCode/visits', asyncHandler(staffController.logOrphanVisit));
...
staffRoutes.get('/events/:id', asyncHandler(staffController.getEventDetail));
staffRoutes.patch('/events/:id/checklist', asyncHandler(staffController.updateChecklistItem));
...
staffRoutes.post('/scan', asyncHandler(staffController.scanQr));
