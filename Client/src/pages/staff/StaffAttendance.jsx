...
import { getAttendanceQueue, markAttendance, issueCertificate, scanQrCode } from '../../api/endpoints/staff';
  ...
  return (
    <DashboardLayout items={STAFF_NAV}>
      ...
      <p className="dashboard-subtitle" style={{ marginBottom: 28 }}>
        Scan a volunteer's QR code on arrival and departure to log their hours automatically, or
        enter hours by hand below for volunteers without one. Meeting an event's minimum hours
        makes a volunteer eligible for a certificate — issue it from here.
      </p>
