...
export const adminOrphans = [
  { id: 'ben-1', childCode: 'CHD-1042', firstName: 'Arjun', lastName: 'Sharma', name: 'Arjun Sharma', dateOfBirth: '2012-04-18', ageGroup: '14 yrs', programId: 'prog-1', program: 'Education Support', attendancePct: 92, attendance: '92%', progress: 'on_track', progressLabel: 'On Track', contactNumber: '9820011122', guardianName: 'Sunita Sharma', address: 'Wadala, Mumbai', backgroundNotes: 'Lost both parents in 2022; lives with maternal aunt.', broughtByName: 'Sunita Sharma', broughtByRelation: 'Aunt', broughtByContact: '9820011122', photoDataUrl: '', broughtByPhotoDataUrl: '' },
  { id: 'ben-2', childCode: 'CHD-1078', firstName: 'Riya', lastName: 'Iyer', name: 'Riya Iyer', dateOfBirth: '2015-09-02', ageGroup: '10 yrs', programId: 'prog-2', program: 'Healthcare Program', attendancePct: 85, attendance: '85%', progress: 'on_track', progressLabel: 'On Track', contactNumber: '9845033344', guardianName: 'Care home warden', address: 'Sahaay Care Home, Pune', backgroundNotes: 'Under regular pediatric follow-up for asthma.', broughtByName: 'Meena Kulkarni', broughtByRelation: 'Neighbor', broughtByContact: '9845033344', photoDataUrl: '', broughtByPhotoDataUrl: '' },
  { id: 'ben-3', childCode: 'CHD-1103', firstName: 'Saanvi', lastName: 'Patil', name: 'Saanvi Patil', dateOfBirth: '2011-01-30', ageGroup: '15 yrs', programId: 'prog-1', program: 'Education Support', attendancePct: 70, attendance: '70%', progress: 'needs_support', progressLabel: 'Needs Support', contactNumber: '9876543210', guardianName: 'Care home warden', address: 'Sahaay Care Home, Nashik', backgroundNotes: 'Attendance dropped after a family visit; flagged for counseling.', broughtByName: 'Ramesh Patil', broughtByRelation: 'Relative', broughtByContact: '9876543210', photoDataUrl: '', broughtByPhotoDataUrl: '' },
];
