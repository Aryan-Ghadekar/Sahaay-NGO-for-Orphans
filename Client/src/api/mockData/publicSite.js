...
export const impactStats = [
  ...
  { value: 560, label: 'Volunteers' },
  { value: 12, label: 'Years of Service' },
];

export const impactBreakdown = [
  { kicker: 'Education', value: 890, body: 'Children in Education Initiatives' },
  { kicker: 'Healthcare', value: 640, body: 'Children in Healthcare Initiatives' },
  { kicker: 'Programs', value: 38, body: 'Programs Completed' },
  { kicker: 'Volunteering', value: 14200, body: 'Volunteer Hours Logged' },
  { kicker: 'Events', value: 64, body: 'Events Conducted' },
  { kicker: 'Reach', value: 1240, body: 'Children Supported Overall' },
];
